 ...
 * <br>
 * If the {@link Method} has ONE parameter, it must have a type that extends the {@link EventManager}'s .
 * This method will only be invoked with the specified {@link #timing()}.
 * <br>
 * If the {@link Method} has TWO parameters, the first parameter must have a type that extends the {@link EventManager}'s ,
